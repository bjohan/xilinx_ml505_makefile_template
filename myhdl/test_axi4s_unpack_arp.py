...
def test_axi4s_unpack_arp():
    ...
    return clkgen, gen_reset, monitor, axi4s_receive_ethernet_inst, axi4s_unpack_ethernet_inst, axi4s_unpack_arp_inst, write, read



tb = test_axi4s_unpack_arp();
