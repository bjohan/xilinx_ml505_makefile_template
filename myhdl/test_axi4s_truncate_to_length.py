...
dataToRead =  [0xA0, 0xA1, 0xA2,                                     0xB2, 0xB3, 0xC0,                   0xC1, 0xC2, 0xC3]
readDelays  = [   0,    3,    0,                                     0,    0,    4,                      0,    0,    0 ]
readLast   =  [   0,    0,    1,                                     0,    0,    1,                      0,    0,    1]

dataToWrite += [0xB0, 0xB1, 0xB2, 0xB3, 0xB4]
writeDelays +=    [0,    0,    0,    0,    0]
writeLast   +=    [0,    0,    0,    0,    1]
dataToRead +=  [0xB0, 0xB1, 0xB2]
readDelays += [   0,    0,    0]
readLast   +=  [   0,    0,    1]
...
writeDelays +=    [0,    0,    0,    0,    0]
writeLast   +=    [0,    0,    0,    0,    1]
dataToRead +=  [0xA0, 0xA1, 0xA2]
readDelays += [   0,     1,    1]
readLast   +=  [   0,    0,    1]

dataToWrite += [0xC0, 0xC1, 0xC2, 0xA3, 0xB0]
writeDelays +=    [0,    0,    0,    1,    1]
writeLast   +=    [0,    0,    0,    0,    1]
dataToRead +=  [0xC0, 0xC1, 0xC2]
readDelays += [   0,     0,    0]
readLast   +=  [   0,    0,    1]
...
dataToWrite += [0xA0, 0xA1 ]
writeDelays +=    [0,    0]
writeLast   +=    [0,    1]
dataToRead +=  [0xA0, 0xA1]
readDelays += [   0,     0]
readLast   +=  [   0,    1]
...
@block
def test_axi4s_truncate_to_length():
    ...
    maximumLength = Signal(intbv(3)[32:])
    axi4s_truncate_to_length_inst = axi4s_truncate_to_length(reset, clk, i, o, maximumLength)
    ...
    return clkgen, gen_reset, axi4s_truncate_to_length_inst, write, read, monitor

tb = test_axi4s_truncate_to_length();
