...
def convert_axi4s_unpack_arp(hdl):
    ...
    axi4s_pack_arp_inst = axi4s_pack_arp(reset, clk, ethernetPayload, hardware_type, protocol_type, hardware_size, protocol_size, opcode, 
                                                                            sender_mac, sender_ip, target_mac, target_ip, arpHeaderValid, arpHeaderReady)

    axi4s_pack_arp_inst.convert(hdl=hdl);
