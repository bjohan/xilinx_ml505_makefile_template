...
@block
def application_test_str(reset, clk, i, o, mdio_in, mdio_out, mdio_tristate, mdio_clk):
    funcaddr= 0x01
    funcaddr2= 0x03
    funcaddr3= 0x05
    debug0 = Signal(modbv(0)[73:0])
    debug1 = Signal(modbv(-1)[13:0])
    ...
    debug_core_inst1 = function_debug_core(reset, clk, i_debug1, o_debug1, debug1, 512)
    ...
    return axi4s_address_branch_inst, debug_core_inst0, axi4s_address_branch_inst2, debug_core_inst1, axi4s_address_branch_inst3, mdio_interface_inst0, logic
